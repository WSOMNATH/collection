import java.util.*;
public class Collectionqustion3 {
	...
	public static void main(String[] args) {
		...
		case 1:
			...
			tree.add(new employee(23,"soma","CSE",40000));
			tree.add(new employee(12,"Sachin","ME",60000));
			tree.add(new employee(24,"nikhil","ECE",30000));
			tree.add(new employee(21,"rushi","CE",40000));
			tree.add(new employee(19,"satyam","CSE",40000));
			tree.add(new employee(9,"shiva","CSE",50000));
			tree.add(new employee(34,"sai","ECE",70000));
			tree.add(new employee(13,"sanket","ME",50000));
